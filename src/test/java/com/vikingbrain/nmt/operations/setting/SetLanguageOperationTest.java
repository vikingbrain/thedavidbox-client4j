...
public class SetLanguageOperationTest extends AbstractClientMock {

	/** Logger. */
	private static Logger logger = LoggerFactory.getLogger(SetLanguageOperationTest.class);
	...
	public SetLanguageOperationTest(String _xmlFileName) throws FileNotFoundException {
	...
	public void checkNmtExistTest() throws Exception {
		...
		SetLanguageOperation operation = theDavidBoxClient.getModuleSetting().
				buildSetLanguageOperation(LANGUAGE_MOCK);
