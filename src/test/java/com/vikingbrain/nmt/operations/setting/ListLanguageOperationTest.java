...
public class ListLanguageOperationTest extends AbstractClientMock {

	/** Logger. */
	private static Logger logger = LoggerFactory.getLogger(ListLanguageOperationTest.class);
	...
	public static Collection<Object[]> data() {		
		Object[][] data = new Object[][] { 
				{ XmlTestFiles.LIST_LANGUAGE_DOCUMENTATION_EXAMPLE },				
				{ XmlTestFiles.LIST_LANGUAGE_A200 }
				};
	    return Arrays.asList(data);
	}

	public ListLanguageOperationTest(String _xmlFileName) throws FileNotFoundException {
	...
	public void listLanguageTest() throws Exception {
		...
		ListLanguageOperation operation = theDavidBoxClient.getModuleSetting().
				buildListLanguageOperation();
