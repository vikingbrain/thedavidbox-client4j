...
/**
 * Abstract class that represent a operation for the network browse module.
 * 
 * @author vikingBrain
 *
 * @param <T> the type of the response object for the operation
 */
public abstract class AbstractNetworkBrowseOperation<T extends DavidBoxResponse> extends AbstractTheDavidboxOperation<T> {
	 ...
	 */
	protected AbstractNetworkBrowseOperation(TheDavidboxOperationFactory factory, OperationType operationType, Class<T> responseTargetClass) {		
