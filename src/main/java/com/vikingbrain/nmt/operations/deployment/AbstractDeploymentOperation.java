 ...
 */
public abstract class AbstractDeploymentOperation<T extends DavidBoxResponse> extends AbstractTheDavidboxOperation<T> {
	 ...
	 */
	protected AbstractDeploymentOperation(TheDavidboxOperationFactory factory, OperationType operationType, Class<T> responseTargetClass) {		
