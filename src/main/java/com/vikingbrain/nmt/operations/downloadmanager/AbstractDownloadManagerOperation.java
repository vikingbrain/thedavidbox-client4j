...
/**
 * Abstract class that represent a operation for the download manager module.
 * 
 * @author vikingBrain
 *
 * @param <T> the type of the response object for the operation
 */
public abstract class AbstractDownloadManagerOperation<T extends DavidBoxResponse> extends AbstractTheDavidboxOperation<T> {
	 ...
	 */
	protected AbstractDownloadManagerOperation(TheDavidboxOperationFactory factory, OperationType operationType, Class<T> responseTargetClass) {		
